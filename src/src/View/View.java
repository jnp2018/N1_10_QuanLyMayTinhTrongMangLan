...
public class View extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Theo dõi các máy thực hành");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String dir = jButton1.getText();
        dir=dir.replace(".", "_");
        String path = "C:\\Users\\daova\\Desktop\\output\\" + dir + "Log.txt"; // path to the directory to be opened
        file = new File(path);
